...
set_velocity(pitch, roll)`
  ...
  const galleryImages = [
    { src: 'gallery-1.png', alt: 'ROMR in laboratory' },
    { src: 'gallery-2.jpg', alt: 'LiDAR scanning' },
    { src: 'gallery-3.png', alt: 'SLAM visualization' },
    { src: 'gallery-4.png', alt: 'Electronics close-up' },
    { src: 'forward_move.png', alt: 'Gesture control demo' },
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Button 
                ...
                onClick={() => window.open('https://github.com/LinusNEP/ROS-Mobile-Robot', '_blank')}
              >
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-[#666666]">
                <li><a href="https://github.com/LinusNEP/ROS-Mobile-Robot" className="hover:text-[#d0ff59] transition-colors">Design Files</a></li>
